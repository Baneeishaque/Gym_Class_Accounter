...
public class Activity_Members extends Gym_Class_Accounter {
    ...
    private Members_RecyclerView_Adapter mAdapter;
    ...
    private void setAdapter() {
        ...
        mAdapter = new Members_RecyclerView_Adapter(Activity_Members.this, modelList);
        ...
        mAdapter.SetOnItemClickListener(new Members_RecyclerView_Adapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int position, AbstractModel model) {

                //handle item click events here
                Toast.makeText(Activity_Members.this, "Hey " + model.getTitle(), Toast.LENGTH_SHORT).show();
