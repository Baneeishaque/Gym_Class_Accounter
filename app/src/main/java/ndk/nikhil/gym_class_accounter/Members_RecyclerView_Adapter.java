 ...
 */
public class Members_RecyclerView_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Members_RecyclerView_Adapter(Context context, ArrayList<AbstractModel> modelList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.member_item_recycler_list, viewGroup, false);
